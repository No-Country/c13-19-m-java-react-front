            ...
            <div className="flex flex-col items-center w-96 gap-5">
                ...
                <form className="flex flex-col gap-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <InputContainer style={{ width: '364px', height: '53px' }} type="email" placeholder="damilolajohn@gmail.com" valueContainerName="input_gmail" />
                    </div>
                    <div className="flex flex-col gap-2">
                        <label className="text-white">contraseña</label>
                        <InputContainer style={{ width: '364px', height: '53px' }} placeholder="1234567" type="password" valueContainerName="input_paswword" />
                        <a>Olvide la contraseña</a>
                    </div>
                    <button className="w-[364px] h-[53px] rounded-2xl bg-[#5316B6] text-white">Iniciar seción</button>
                </form>
