            ...
            <div className="flex flex-col items-center w-96 gap-5">
                ...
                <form onSubmit={(e) => handleSubmit(e)} className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <InputContainer onChange={handleEmail} style={{ width: '364px', height: '53px' }} type="email" placeholder="damilolajohn@gmail.com" valueContainerName="input_gmail" />
                        { }
                    </div>
                    <div className="flex flex-col gap-2">
                        <label className="text-white">contraseña</label>
                        <InputContainer onChange={handlePassword} style={{ width: '364px', height: '53px' }} placeholder="1234567" type="password" valueContainerName="input_paswword" />
                        <a className="text-white">Olvide la contraseña</a>
                    </div>
